...
$lang = array (
  ...
  'plugins_upgrade_succeed' => '插件成功更新到 {toversion}<br /><br /><a href="https://addon.dismall.com/?view=plugins" target="_top">点击这里返回应用中心</a><br />',
  ...
  'tpl_directory_invalid' => '模板目录 {directory} 不存在于 ./template/ 目录中，或以 "/" 结尾',
  ...
  'members_add_username_tooshort' => '抱歉，您输入的用户名小于 3 个字符，请输入一个较长的用户名',
  'members_add_username_toolong' => '抱歉，您的用户名超过 15 个字符，请输入一个较短的用户名',
  ...
  'plugins_config_upgrade_missed' => '此插件已更新到最新版本</h4><br /><a href="https://addon.dismall.com/?view=plugins" target="_top" class="lightlink">点击这里进入应用中心</a><br /><br /><h4>',
  'plugins_config_upgrade_new' => '此插件已更新到最新版本<br />但是发现此插件在应用中心存在新版本 {newver}，是否需要升级？</h4><br /><a href="{ADMINSCRIPT}?action=cloudaddons&id={addonid}&from=newver" target="_top" class="lightlink">升级此插件</a> &nbsp;&nbsp; <a href="{ADMINSCRIPT}?action=plugins" class="lightlink">暂不升级</a><h4>',
  ...
  'styles_delete_invalid' => '您不能直接删除正在使用中的模板风格，选择使用其他模板风格为默认后再进行删除',
  'styles_install_succeed' => '界面方案安装完成<br /><br /><a href="https://addon.dismall.com?view=templates" target="_top">点击这里返回应用中心</a><br />',
  ...
  'cloudaddons_genuine_message' => '对不起，您安装的不是正版应用，安装程序无法继续执行<br /><br /><a href="{ADMINSCRIPT}?action=cloudaddons&id={addonid}" target="_top">点击这里安装正版应用</a>',
