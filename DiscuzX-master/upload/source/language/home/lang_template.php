...
$lang = array (
  ...
  'description' => '描述',
  'help' => '帮助',
  'how_to_share_tips' => '<strong>如何分享视频？</strong><br/>填写视频所在网页的网址。(不需要填写视频的真实地址)<br/>我们支持的视频网站有：<br/>Youtube、优酷、酷6、Mofile、偶偶视频、56、新浪视频、搜狐视频等常见视频网站。<br/><br/><strong>如何分享音乐？</strong><br/>填写音乐文件的地址。(后缀支持aac、flac、mp3、m4a、wav、ogg)',
  'share_description' => '分享说明',
  'share_web_music_flash' => '分享网址、视频、音乐',
  'sharemetoo' => '我也分享',
  'friend_share' => '好友的分享',
